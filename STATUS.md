...
9. У тасков могут быть подтаски. Выполнение всех подтасков не означает выполнение их родительского таска, но выполнение родительского таска означает выполнение всех его дочерних. Вложенность подтасков не ограничена
...
11. Таск может быть Просроченным. В таком случае ему нужно переназначить время или убрать его вовсе.
...
22. Давать доступ другим пользователям к определенным проктам.
...
24. Администратор имеет право создавать и изменять таски, а также назначать участников как отвественных за таски. Остальные участники в общем случае только просматривать таски.
...
1. Календарь в котором есть поддержка просмотра задач на определенную неделю или на месяц
2. Для каждого проекта запоминается история изменений.
3. Связывание тасков на равных правах. По сути это информационное связывание, когда выполнение одного таска никак не зависит и никак не влияет на дургие таски.
4. Создание блокирующих тасков. Это связь, когда нельзя установить таск как выполненный пока блкоирующий его таск не будет указан к выполенный.
5. Администратор может отправить внеплановое уведомление ответственному за таск, чтобы как-то уведомить/стимулировать отвественного.
6. Можно к таскам отправлять комментарии. Любой участник имеет право писать комментарий к любому таску.
7. Вывод статистики по ошибкам в планировании за промежуток времени: количество изменений тасков, погрешность в предполагаемом конце задачи/крайнем конце задачи относительно реально потраченного времени.
8. Сохраняется время создания таска и когда у таска сменили состояние. Потом можно будет показать пользователю статистику: сколько реально заняло выполнение таска, сколько таск "провисел" в ожидании.
